                                ...
                                <div id="rev_slider_1_1" class="rev_slider fullwidthabanner" style="display:none;"
                                    ...
                                    <ul>    <!-- SLIDE  -->
                                        <li data-index="rs-2" data-transition="slidingoverlayleft"
                                            ...
                                            data-thumb="http://tonatheme.com/newwp/factory/wp-content/uploads/2017/07/2-100x50.jpg"
                                            data-rotate="0"
                                            ...
                                            data-description="">
                                            <!-- MAIN IMAGE -->
                                            <img src="http://tonatheme.com/newwp/factory/wp-content/uploads/2017/07/2.jpg"
                                                 alt="" title="2" width="1920" height="880"
                                        ...
                                        <!-- SLIDE  -->
                                        <li data-index="rs-1" data-transition="slidingoverlayright"
                                            data-slotamount="default" data-hideafterloop="0"
                                            data-hideslideonmobile="off" data-easein="default" data-easeout="default"
                                            data-masterspeed="default"
                                            data-thumb="http://tonatheme.com/newwp/factory/wp-content/uploads/2017/07/1-100x50.jpg"
                                            data-rotate="0"
                                            data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
                                            data-param3="" data-param4="" data-param5=""
                                            data-param6="" data-param7="" data-param8="" data-param9="" data-param10=""
                                            data-description="">
                                            <!-- MAIN IMAGE -->
                                            <img src="http://tonatheme.com/newwp/factory/wp-content/uploads/2017/07/1.jpg"
                                                 alt="" title="1" width="1920" height="880"
                                                 data-bgposition="center center" data-bgfit="cover"
                                                 data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                                            <!-- LAYERS -->
                                        ...
                                        <!-- SLIDE  -->
                                        <li data-index="rs-3" data-transition="slidingoverlayright"
                                            data-slotamount="default" data-hideafterloop="0"
                                            data-hideslideonmobile="off" data-easein="default" data-easeout="default"
                                            data-masterspeed="default"
                                            data-thumb="http://tonatheme.com/newwp/factory/wp-content/uploads/2017/07/3-100x50.jpg"
                                            data-rotate="0"
                                            data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
                                            data-param3="" data-param4="" data-param5=""
                                            data-param6="" data-param7="" data-param8="" data-param9="" data-param10=""
                                            data-description="">
                                            <!-- MAIN IMAGE -->
                                            <img src="http://tonatheme.com/newwp/factory/wp-content/uploads/2017/07/3.jpg"
                                                 alt="" title="3" width="1920" height="887"
                                                 data-bgposition="center center" data-bgfit="cover"
                                                 data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                                            <!-- LAYERS -->
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <figure class="about-img">
                                        <img src="http://tonatheme.com/newwp/factory/wp-content/uploads/2017/07/1.png"
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="about-text">
                                        ...
                                        <div class="text">
                                            <p>Thank you for being a friend. Travelled down the road and back again.
                                                Your heart is true you're a pal and a confidant. It's
                                                time to put on makeup. It's time to dress up right.They're all together
                                                ooky the Addams Family doin' it our way. There's
            ...
            <div class="kc-elm kc-css-333317 kc_col-sm-12 kc_column kc_col-sm-12">
                <div class="kc-col-container">
                    ...
                    <section class="latest-project sec-padd"
                             style="background-image: url(http://tonatheme.com/newwp/factory/wp-content/uploads/2017/07/5-1.jpg);">
                        <div class="container">
                            <div class="section-title">
                                ...
                                @foreach($partners as $partner)
                                    <li>
                                        <a href="#">
                                            <img title=
                                                    {{
                                                        $partner->{'name_'.App::getlocale()}
                                                    }}
                                                    src="{{ asset('/storage/upload/'.$partner->img) }}"
                                                    alt="Capital Power">
                                        </a>
                                    </li>
                                @endforeach
