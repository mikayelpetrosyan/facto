...
@endif
<form class="form-horizontal" role="form" action="{{ route('addshop') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="app_img" class="col-sm-3 control-label ">Shop img</label>
        <div class="col-sm-9">
            <div>
